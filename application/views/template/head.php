<head>
    ...
    <link rel="stylesheet" href="/application/css/style.css" media="screen">
    <!--[if lte IE 7]><link rel="stylesheet" href="style.ie7.css" media="screen" /><![endif]-->
    <link rel="stylesheet" href="/application/css/style.responsive.css" media="all">
    
    <script src="/application/js/jquery.js"></script>
    <script src="/application/js/script.js"></script>
    <script src="/application/js/script.responsive.js"></script>
